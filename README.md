...
# Max广告接入
 ...
 ## [MAX 接入文档-Android](https://developers.applovin.com/en/max/android/overview/integration/)

  ### [Max 如何测试Android广告是否接入正确](https://developers.applovin.com/en/max/android/testing-networks/mediation-debugger/)

  ### [Max Android错误码信息说明](https://developers.applovin.com/en/max/android/overview/error-handling/)

</br>

 ## [MAX 接入文档-Unity](https://developers.applovin.com/en/max/unity/overview/integration/)

  ### [Max Unity错误码信息说明](https://developers.applovin.com/en/max/unity/overview/error-handling/)

  ### [Max 如何测试Unity广告是否接入正确](https://developers.applovin.com/en/max/unity/testing-networks/mediation-debugger/)
